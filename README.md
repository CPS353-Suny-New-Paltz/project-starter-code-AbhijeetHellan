...
1. **Unit Benchmark** (Algorithm Only)
   * Original (Slow): 155 ms
   * Optimized (Fast): 50 ms
   * Improvement: **210.00%**

2. **Integration Benchmark** (Full Engine)
   * Original (Slow): 794 ms
   * Optimized (Fast): 571 ms
   * Improvement: **39.05%**
...
* **Unit Benchmark:** [ConceptualApiBenchmarkTest.java](https://github.com/CPS353-Suny-New-Paltz/project-starter-code-AbhijeetHellan/blob/main/test/performancetesting/ConceptualApiBenchmarkTest.java)
* **Integration Benchmark:** [ComputeEngineIntegrationBenchmarkTest.java](https://github.com/CPS353-Suny-New-Paltz/project-starter-code-AbhijeetHellan/blob/main/test/performancetesting/ComputeEngineIntegrationBenchmarkTest.java)
